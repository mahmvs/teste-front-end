      ...
      <div className={styles.headerTop}>
        <ul className={styles.headerTopList}>
          <li className={styles.headerTopListItem}>
             <img className={styles.headerTopIcon} src={Seguranca} alt="Ícone de segurança" />
            Compra <span className={styles.headerTopSpanList}>100% segura</span>
            </li>
          <li className={styles.headerTopListItem}>
             <img className={styles.headerTopIcon} src={Transporte} alt="Ícone de transporte" />
             <span className={styles.headerTopSpanList}>Frete grátis</span> acima de R$ 200</li>
          <li className={styles.headerTopListItem}> 
             <img className={styles.headerTopIcon} src={Cartao} alt="Ícone de cartão" />
            <span className={styles.headerTopSpanList}>Parcele</span> suas compras
            </li>
        </ul>
      </div>
      ...
      <div className={styles.headerBottom}>
        <nav className={styles.nav}>
          <ul className={styles.navList}>
            ...
            <li className={`${styles.navItem} ${styles.headerTopSpanList}`}>Oferta do dia</li>
            <li className={styles.navItem}
            >
              <img  className={styles.headerTopIcon} src={Coroa} alt="Ícone de coroa" />
               Assinatura
            </li>
